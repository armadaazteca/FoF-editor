...
QuickGuideDialog::QuickGuideDialog(wxWindow * parent) : wxDialog(parent, wxID_ANY, "Quick guide", wxDefaultPosition, wxSize(640, 480))
{
  ...
  const char * guideText = "QUICK GUIDE - OVERVIEW OF EDITOR FUNCTIONALITY\n"
	                         ...
	                         "multiple sprites, into single picture as you see it in the editor.\n"
	                         "Third item - \"Delete this sprite\" - will delete this sprite from current animation frame.\n"
	                         ...
	                         "body may not be blocking to its tallness (when locking from top-down perspective).\n"
                           ...
                           "\"Frame time\" field sets time for current frame in milliseconds. This means that particular frame will be "
	                         ...
	                         "frame will have some average time set for all animations. E.g. if all frames have default frame time "
	                         "they all will be shown for same amount of time.\n"
	                         ...
	                         "First option there is auto-backup feature. It's enabled by default, and backup will be performed every 10 minutes. "
	                         ...
	                         "So in preferences you can turn auto-backup on and off as well as change how often it will performed.\n\n"
													 "At last, keep in mind that you can undo / redo most editor operations using standard Ctrl+Z / Ctrl+Y hotkeys.";
